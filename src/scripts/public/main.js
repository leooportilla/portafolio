...
//! Variable necesaria para el observador, donde en cada carga de la funcion project guardaremos todas las cards generadas
let dataProject$1;

//! Informacion de los lenguaje de programacion
const language = {
    javascript: {
...
const templateCard = (image, name, stars, description, skills, page, code) => {
    ...
    <div class="cards__container-card-statistics">
        ...
        <h4 class="cards__container-card-statistics-count">${stars}</h4>
    </div>
...
//! Plantailla para las habilidades de cada proyecto
...
//! El tamaño del slider segun el tamaño de pantalla 
const config = () => {
    if (window.screen.width > 600) return 86
    if (window.screen.width <= 600) return 76
};

//! Configuracion de cuantas tarjetas se deben mostrar en cada tamaño de pnatalla
const countCards = () => {
                ...
                data.forEach(repository => {
                    ...
                    switch (repository.name) {
                        ...
                        case `leooportilla`:
                            ...
                            nameRepository = `Readme Principal`;
                            break;
...
//! Funcion para las flecha del slider, asi poder moverla con el telcado o el mouse
const arrow = () => {
    ...
    //! Pendiente al evento de las flechas
    rightButton.addEventListener(`click`, () => {
        ...
        if (rightButton.classList.contains(`active-arrow`)) {
            ...
            if (countMove < parseInt(localStorage.getItem(`Lenght`))) {
                ...
                //! Gracias a la funcion segun el tamaño de pantalla es que se movera el slider
                translate += config();
                countMove++;
