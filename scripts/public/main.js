...
const language = {
    ...
    reatjs: {
        svg: `<svg class="skills__container-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 498.63 550.4">
...
//! Esta variable contendra todos los proyectos en total, para hacer con ellos funciones con el intersetion observer
let dataProject$1;

//! Fucion para el intersetion obeserve
...
const templateCard = (image, name, star, description, skills, page, code) => {
    ...
    <div class="cards__container-card-statistics">
        <svg class="cards__container-card-statistics-icon" viewBox="0 0 33 32" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <h4 class="cards__container-card-statistics-count">${star}</h4>
    </div>
    ...
    <div class="hover">
        ...
        <div class="hover__information">
            ...
            <p class="hover__information-paragraph">${description}</p>

            <div class="hover__information-skills skills">${skills}</div>
        </div>

        <div class="hover__footer">
            <a class="hover__footer-visit" href="${page}" target="_blank">
            ...
            <a class="hover__footer-code" href="${code}" target="_blank">
...
//! Plantilla para los lenguaje en cada proyectos
const templateLanguage = (url, svg) => {
    return `<a class="skills__container" href="${url}" target="_blank">
        ${svg}
    </a>`
};

//! Configuracion para el tamaño del slider, segun el tamaño de pantalla
const config = () => {
    if (window.screen.width > 600) return 86
    if (window.screen.width <= 600) return 76
};

//! Configuracion para cuantas tarjetas se deben mostrar en cada tamaño de pantalla
const countCards = () => {
    ...
    try {
        ...
        if (answer.status === 200) {
            ...
            if (data.length > 0) {
                ...
                //! Guardamos los proyectos nuevos en la variable
                dataProject$1 = document.querySelectorAll(`[data-observe="project"]`);
                ...
                //! Focus para que al cargar todos los proyecto el usuario puede deslizarse en ello con el teclado
                containerCards.focus();
            } else {

                //! Si el usuario no contiene ningun repositorio simplemnte se desactivan las flechas y agregamos un mensaje 
...
const errorProfile$1    = document.querySelector(`.user__error`);
