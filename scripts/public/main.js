            ...
            if (data.length > 0) {
                ...
                data.forEach(repository => {
                    ...
                    if (window.screen.width > 1328) {
                        if (count <= 4) {
                            cardsOne.insertAdjacentHTML(`beforeend`, `<div class="cards__container-card" data-observe="project"  style="background-image: url(./media/images/project_${imageRepository}.png);">

                                <h3 class="cards__container-card-title">${nameRepository}</h3>
                                ...
                                <div class="cards__container-card-statistics">
                                    ...
                                    <h4 class="cards__container-card-statistics-count">${repository.stargazers_count}</h4>
                                </div>
                            ...
                            <div class="hover">
                                ...
                                <div class="hover__information">
                                    ...
                                    <p class="hover__information-paragraph">${descriptionRepository}</p>
        
                                    <div class="hover__information-skills skills">${template}</div>
                                </div>
        
                                <div class="hover__footer">
                                    <a class="hover__footer-visit" href="${repository.homepage}" target="_blank">
                                    ...
                                    <a class="hover__footer-code" href="${repository.html_url}" target="_blank">
                        ...
                        if (count > 4 && count <= 8) {
                            cardsTwo.insertAdjacentHTML(`beforeend`, `<div class="cards__container-card" data-observe="project" style="background-image: url(./media/images/project_${imageRepository}.png);">
                            <h3 class="cards__container-card-title">${nameRepository}</h3>
