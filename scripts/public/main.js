        ...
        if (answer.status === 200) {
            ...
            if (data.length > 0) {
                ...
                data.forEach(repository => {
                    ...
                    if (widthMax.matches) {
                        if (count <= 4) {
                            cardsOne.insertAdjacentHTML(`beforeend`, `<div class="cards__container-card">
                        ...
                        if (count > 4 && count <= 8) {
                            cardsTwo.insertAdjacentHTML(`beforeend`, `<div class="cards__container-card">
                            <img class="cards__container-card-image" src="./media/images/project_${imageRepository}.png" alt="Projecto del portafolio pagina web">
                    ...
                    /* else if (width1328px.matches) {
                                           ...
                                           if (count <= 3) {
                                               ...
                                               <div class="cards__container-card-hover">
