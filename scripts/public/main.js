                ...
                data.forEach(repository => {
                    ...
                    if (window.screen.width > 1328) {
                        if (count <= 4) {
                            ...
                            <div class="cards__container-card-name name">

                                <h3 class="name__title">${nameRepository}</h3>

                                <div class="name__statistics">
                                    <svg class="name__statistics-icon" viewBox="0 0 33 32" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <h4 class="name__statistics-count">${repository.stargazers_count}</h4>
                                </div>
                            </div>
                        ...
                        if (count > 4 && count <= 8) {
                            cardsTwo.insertAdjacentHTML(`beforeend`, `<div class="cards__container-card" data-observe="project">
                            <img class="cards__container-card-image" src="./media/images/project_${imageRepository}.png" alt="Projecto del portafolio pagina web">
                            <div class="cards__container-card-name name">
